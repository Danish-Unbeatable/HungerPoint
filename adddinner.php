...
//$conn=mysqli_connect("localhost","id13682396_ayesha","_=-n1A&b2D_<J*_v","id13682396_hungerpoint");
    ...
    else
    {
        ...
        if(isset($_GET['edit']))
        {
            $id=$_GET['edit'];
            $update=true;
            $result=mysqli_query($conn,"SELECT * FROM dinner where id='$id'");
        ...
        if(isset($_POST['update']))
        {
            ...
            $file_name=$_FILES['file']['name'];
               ...
               $destinationfile='lunch/'.$file_name;
               move_uploaded_file($file_temp_loc,$destinationfile);
               
                
        
            $sql="UPDATE dinner SET name='$name',price='$price',description='$description',img='$destinationfile' WHERE id='$id'";
...
<body>
    <div id="container">
        ...
        <div class="container">
             <div class="card">
                <center><h3><b>Add Dinner</b></h3></center>
            ...
            <table class="table table-striped table-dark  " id="table">
               ...
               // $conn=mysqli_connect("localhost","id13682396_ayesha","_=-n1A&b2D_<J*_v","id13682396_hungerpoint");
                ...
                <tr>
                            ...
                            <td><a href="addlunch.php?edit=<?=$row['id']?>" class="btn btn-info">Update</a></td>
                            <td><a href="delete_dinner_product.php?id=<?=$row['id']?>" class="btn btn-danger">Delete</a></td>
                </tr>   
...
else
{
    if(isset($_POST['submit']))
    {
       ...
       $file_size=$_FILES['file']['size'];
       $file_temp_loc=$_FILES['file']['tmp_name'];
       $destinationfile='dinner/'.$file_name;
       move_uploaded_file($file_temp_loc,$destinationfile);
       $sql="INSERT INTO dinner(name,price,description,img)VALUES('$pname','$pprice','$pdesc', '$destinationfile')";
       if(mysqli_query($conn,$sql))
        {
