...
//$conn=mysqli_connect("localhost","id13682396_ayesha","_=-n1A&b2D_<J*_v","id13682396_hungerpoint");
    ...
    else
    {
        ...
        if(isset($_GET['edit']))
        {
            $id=$_GET['edit'];
            $update=true;
            $result=mysqli_query($conn,"SELECT * FROM lunch where id='$id'");
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql="UPDATE lunch SET name='$name',price='$price',description='$description',img='$destinationfile' WHERE id='$id'";
...
<body>
    <div id="container">
        ...
        <div class="container">
            <div class="card">
                <center><h3><b>Add Lunch</b></h3></center>
            ...
            <table class="table table-striped table-dark  " id="table">
               ...
               // $conn=mysqli_connect("localhost","id13682396_ayesha","_=-n1A&b2D_<J*_v","id13682396_hungerpoint");
                ...
                <tr>
                            ...
                            <td><a href="delete_lunch_product.php?id=<?=$row['id']?>" class="btn btn-danger">Delete</a></td>
                </tr>   
...
else
{
    if(isset($_POST['submit']))
    {
       ...
       $destinationfile='lunch/'.$file_name;
       move_uploaded_file($file_temp_loc,$destinationfile);
       $sql="INSERT INTO lunch(name,price,description,img)VALUES('$pname','$pprice','$pdesc', '$destinationfile')";
       if(mysqli_query($conn,$sql))
        {
