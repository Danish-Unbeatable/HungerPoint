...
//$conn=mysqli_connect("localhost","id13682396_ayesha","_=-n1A&b2D_<J*_v","id13682396_hungerpoint");
    ...
    else
    {
        ...
        if(isset($_GET['edit']))
        {
            $id=$_GET['edit'];
            $update=true;
            $result=mysqli_query($conn,"SELECT * FROM breakfast where id='$id'");
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql="UPDATE breakfast SET name='$name',price='$price',description='$description',img='$destinationfile' WHERE id='$id'";
        ...
        <div class="container">
            ...
            ?>
                <tr>
                            ...
                            <td><a href="adbrkfast.php?edit=<?=$row['id']?>" class="btn btn-info">Update</a></td>
                            <td><a href="delete_break_product.php?id=<?=$row['id']?>" class="btn btn-danger">Delete</a></td>
                </tr>   
...
else
{
    if(isset($_POST['submit']))
    {
       ...
       $destinationfile='breakfast/'.$file_name;
       move_uploaded_file($file_temp_loc,$destinationfile);
       $sql="INSERT INTO breakfast(name,price,description,img)VALUES('$pname','$pprice','$pdesc', '$destinationfile')";
       if(mysqli_query($conn,$sql))
        {
